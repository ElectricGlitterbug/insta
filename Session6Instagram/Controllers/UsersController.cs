...
namespace Session6Instagram.Controllers
{
    ...
    {
        private InstagramDbContext db = new InstagramDbContext();
        ...
        public ActionResult Create([Bind(Include = "Id,Name,DisplayName")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,DisplayName")] User user)
        {
            if (ModelState.IsValid)
            {
